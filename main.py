...
class Student:
    def __init__(self,root):
        ...
        title=Label(self.root, text= "Student Management System",font=("Arial",35,"bold"),bg="lightblue")
    ...
    #========Manage_Frame=======
        ...
        m_title=Label(Manage_Frame,text="Manage Students",font=("Arial",20,"bold"),bg="lightblue")
        m_title.grid(row=0,columnspan=2,pady=20)

        lbl_roll=Label(Manage_Frame,text="Roll No.",font=("Arial",15,"bold"),bg="lightblue")
        lbl_roll.grid(row=1,column=0,pady=10,padx=20,sticky="w")

        txt_roll= Entry(Manage_Frame,textvariable=self.Roll_No_var,font=("Arial",15,"bold"),bg="lightblue")
        txt_roll.grid(row=1,column=1,pady=10,padx=20,sticky="w")
        
        lbl_name= Label(Manage_Frame,text="Name",font=("Arial",15,"bold"),bg="lightblue")
        lbl_name.grid(row=2,column=0,pady=10,padx=20,sticky="w")

        txt_name= Entry(Manage_Frame,textvariable=self.name_var,font=("Arial",15,"bold"),bg="lightblue")
        txt_name.grid(row=2,column=1,pady=10,padx=20,sticky="w")

        lbl_email= Label(Manage_Frame,text="Email",font=("Arial",15,"bold"),bg="lightblue")
        lbl_email.grid(row=3,column=0,pady=10,padx=20,sticky="w")

        txt_email= Entry(Manage_Frame,textvariable=self.email_var,font=("Arial",15,"bold"),bg="lightblue")
        txt_email.grid(row=3,column=1,pady=10,padx=20,sticky="w")

        lbl_gender= Label(Manage_Frame,text="Gender",font=("Arial",15,"bold"),bg="lightblue")
        ...
        lbl_contact= Label(Manage_Frame,text="Contact",font=("Arial",15,"bold"),bg="lightblue")
        lbl_contact.grid(row=5,column=0,pady=10,padx=20,sticky="w")

        txt_contact= Entry(Manage_Frame,textvariable=self.contact_var,font=("Arial",15,"bold"),bg="lightblue")
        txt_contact.grid(row=5,column=1,pady=10,padx=20,sticky="w")

        lbl_dob= Label(Manage_Frame,text="D.O.B",font=("Arial",15,"bold"),bg="lightblue")
        lbl_dob.grid(row=6,column=0,pady=10,padx=20,sticky="w")

        txt_dob= Entry(Manage_Frame,textvariable=self.dob_var,font=("Arial",15,"bold"),bg="lightblue")
        txt_dob.grid(row=6,column=1,pady=10,padx=20,sticky="w")

        lbl_address= Label(Manage_Frame,text="Address",font=("Arial",15,"bold"),bg="lightblue")
        lbl_address.grid(row=7,column=0,pady=10,padx=20,sticky="w")
        
        self.txt_address = Text(Manage_Frame,width=31,height=4,font=("arial",10),bg="lightblue")
    ...
    #========Deatil_Frame=======
        ...
        lbl_search= Label(Detail_Frame,text="Search By",font=("Arial",15,"bold"),bg="lightblue")
        ...
        txt_search= Entry(Detail_Frame,textvariable=self.search_txt,width=15,font=("Arial",15,"bold"),bg="lightblue")
